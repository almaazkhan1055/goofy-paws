...
const NavBar = () => {
  ...
  return (
    <header className="bg-white">
      <nav
        aria-label="Global"
        className="flex max-w-7xl items-center justify-between p-6 lg:px-8 bg-[#F7F6F9] rounded-[60px]"
      >
        ...
        <PopoverGroup className="hidden lg:flex lg:gap-x-12">
          <Popover className="relative">
            <PopoverButton className="flex items-center gap-x-1 text-xl font-medium leading-6 text-gray-900">
              OUR PRODUCT
              <ChevronDownIcon
                aria-hidden="true"
