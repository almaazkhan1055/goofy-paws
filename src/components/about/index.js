  ...
  return (
    <div className="sm:my-40 flex justify-between sm:flex-row flex-col sm:gap-0 gap-10">
      ...
      <div className="right flex flex-col justify-between sm:w-[560px]">
        <Image src={cat} alt="cat" className="rounded-[32px]  my-10 sm:mb-0" />
        <div className="gap-4">
          <h2 className="font-semibold sm:text-[55px] sm:leading-[55px] leading-[42px] text-[42px] mb-5 sm:text-left text-center">
