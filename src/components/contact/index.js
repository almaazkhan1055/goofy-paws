...
const Contact = () => {
  return (
    <div className="bg-[#E8DDFF] md:px-52 px-0 md:py-20 py-40 relative flex flex-col md:mb-0 ">
      <TextConatiner
        textHead="CONNECT WITH US"
        textDesc="Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliq."
      />
